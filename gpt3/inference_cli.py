...
from gpt3.generate_prompt import generate_inference_prompt_from_file
from gpt3.inference import from_chord_csv_to_chord_score, from_gpt3_response_to_abc_notation, \
    merge_backing_midi_and_melody_abc, merge_backing_midi_and_melody_midi, to_chord_score
...
flags.DEFINE_string('intermediate_dir', '', '')
...
def main(unused_argv) -> None:
    ...
    intermediate_dir = pathlib.Path(FLAGS.intermediate_dir)
    prompts = []
